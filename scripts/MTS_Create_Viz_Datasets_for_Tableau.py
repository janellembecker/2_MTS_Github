...
path = monthly_dir + "/mts0417.xls" #replace the new MTS file name 
...
deficit_mo = (df9['amt'][index_tot_rec] - df9['amt'][index_tot_out]) 
deficit_fytd = (df9['fytd'][index_tot_rec] - df9['fytd'][index_tot_out])
